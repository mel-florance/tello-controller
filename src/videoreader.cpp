...
bool VideoReader::open(VideoReaderState* state, const char* filename) {
...
bool VideoReader::read_frame(VideoReaderState* state, uint8_t* frame_buffer, int64_t* pts) {
...
bool VideoReader::seek_frame(VideoReaderState* state, int64_t ts) {
...
void VideoReader::close(VideoReaderState* state) {
